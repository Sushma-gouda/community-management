    ...
    <section className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-4 sm:px-6">
        <div className="mx-auto max-w-3xl text-center pt-24 pb-20">
          ...
          <h1 className="mt-6 text-balance font-display font-semibold tracking-tight text-white animate-fade-up
          ...
          <p className="mx-auto mt-5 max-w-xl text-pretty text-white/75 text-base sm:text-lg leading-relaxed animate-fade-up"
             style={{ animationDelay: "120ms" }}>
            A complete digital platform for apartment residents, security, and administrators
          ...
          <div className="mt-10 flex items-center justify-center gap-6 text-xs text-white/60 animate-fade-up"
