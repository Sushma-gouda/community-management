  ...
  return (
    <DashboardLayout role="Admin" items={adminNav}>
      <div className="space-y-6 animate-fade-up">
        ...
        <div className="grid lg:grid-cols-3 gap-4">
          <div className="lg:col-span-2">
            <Card title="Recent Complaints" action={<a className="text-xs text-primary hover:underline" href="#">View all</a>}>
        ...
        <div className="grid lg:grid-cols-3 gap-4">
          <Card title="Recent Payments" action={<a className="text-xs text-primary hover:underline" href="#">All transactions</a>}>
