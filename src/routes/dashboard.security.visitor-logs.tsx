...
type LogEntry = {
  ...
  purpose: VisitorType; checkIn: string; checkOut?: string; vehicle?: string;
  date: string; guard: string;
};

const allLogs: LogEntry[] = [
  { id: "V-501", name: "Rohan Mehta", phone: "+91 99887 11223", flat: "A-204", host: "Priya Mehta", purpose: "Guest", checkIn: "10:42 AM", date: "May 11, 2026", guard: "R. Singh" },
  { id: "V-500", name: "Amazon Delivery", phone: "+91 99887 22334", flat: "B-302", host: "Anika Sharma", purpose: "Delivery", checkIn: "10:31 AM", checkOut: "10:38 AM", date: "May 11, 2026", guard: "R. Singh" },
  { id: "V-499", name: "Plumber — Suresh", phone: "+91 99887 33445", flat: "C-101", host: "Sunil Joshi", purpose: "Service", checkIn: "10:21 AM", date: "May 11, 2026", guard: "R. Singh" },
  { id: "V-498", name: "Uber Cab", phone: "+91 99887 44556", flat: "D-405", host: "Arjun Rao", purpose: "Cab", checkIn: "09:55 AM", checkOut: "10:02 AM", vehicle: "MH-04 XY-9988", date: "May 11, 2026", guard: "M. Patil" },
  { id: "V-497", name: "Ravi Kumar (Family)", phone: "+91 99887 55667", flat: "D-405", host: "Arjun Rao", purpose: "Guest", checkIn: "09:30 AM", date: "May 11, 2026", guard: "M. Patil" },
  { id: "V-496", name: "Swiggy Delivery", phone: "+91 99887 66778", flat: "A-101", host: "Ravi Kumar", purpose: "Delivery", checkIn: "09:15 AM", checkOut: "09:20 AM", date: "May 11, 2026", guard: "M. Patil" },
  { id: "V-495", name: "Electrician — Ramesh", phone: "+91 99887 77889", flat: "B-302", host: "Anika Sharma", purpose: "Service", checkIn: "09:00 AM", checkOut: "11:30 AM", vehicle: "MH-12 XY-1234", date: "May 11, 2026", guard: "M. Patil" },
  { id: "V-494", name: "Meera's Parents", phone: "+91 99887 88990", flat: "C-204", host: "Meera Pillai", purpose: "Guest", checkIn: "08:30 AM", checkOut: "01:00 PM", date: "May 10, 2026", guard: "K. Sharma" },
  { id: "V-493", name: "Zomato Delivery", phone: "+91 99887 99001", flat: "A-204", host: "Priya Mehta", purpose: "Delivery", checkIn: "08:15 AM", checkOut: "08:20 AM", date: "May 10, 2026", guard: "K. Sharma" },
  { id: "V-492", name: "AC Technician", phone: "+91 99887 00112", flat: "B-302", host: "Anika Sharma", purpose: "Service", checkIn: "10:00 AM", checkOut: "12:30 PM", date: "May 10, 2026", guard: "K. Sharma" },
];
  ...
  return (
    <DashboardLayout role="Security" items={securityNav}>
      <div className="space-y-6 animate-fade-up">
        <PageHeader title="Visitor Logs" subtitle="Complete searchable history of all visitor entries." />

        {/* Stats */}
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <StatCard label="Total Entries" value={String(allLogs.length)} icon={LogIn} tone="primary" />
          <StatCard label="Currently Inside" value={String(inside)} icon={LogIn} tone="success" />
          <StatCard label="Checked Out" value={String(allLogs.length - inside)} icon={LogOut} tone="accent" />
          <StatCard label="Deliveries" value={String(allLogs.filter((l) => l.purpose === "Delivery").length)} icon={Car} tone="warning" />
        </div>
              ...
              <tbody>
                {filtered.map((l) => (
                  ...
                  >
                    ...
                    <td className="px-2 py-3"><Badge tone={purposeTone(l.purpose)}>{l.purpose}</Badge></td>
          ...
          <div className="relative w-full max-w-md rounded-2xl glass-strong shadow-elegant p-6 animate-scale-in">
            ...
            <div className="space-y-2.5">
              {[
                ...
                { icon: LogIn, label: "Checked in", value: `${selected.date} · ${selected.checkIn}` },
                ...(selected.checkOut ? [{ icon: LogOut, label: "Checked out", value: selected.checkOut }] : []),
                ...(selected.vehicle ? [{ icon: Car, label: "Vehicle", value: selected.vehicle }] : []),
            ...
            <div className="mt-6 flex justify-end">
              <button onClick={() => setSelected(null)} className="h-10 px-4 rounded-lg text-sm font-medium hover:bg-foreground/5">
                Close
              </button>
            </div>
          </div>
