...
const flats = [
  "A-101", "A-204", "A-302", "A-405",
  "B-101", "B-204", "B-302", "B-405",
  "C-101", "C-204", "C-302", "C-405",
  "D-101", "D-204", "D-302", "D-405",
];
...
function AddVisitor() {
  ...
  const [form, setForm] = useState({
    name: "", phone: "", vehicle: "", flat: "", purpose: "Guest" as VisitorType, notes: "",
  });
  ...
  return (
    <DashboardLayout role="Security" items={securityNav}>
      <div className="space-y-6 animate-fade-up">
        <PageHeader
          title="Add Visitor"
          subtitle="Register a new visitor entry at the gate."
        />
          ...
          {[
            ...
            return (
              <div key={s.step} className="flex items-center gap-2 flex-1">
                <div className={`flex items-center gap-2 ${active ? "text-primary" : done ? "text-[color:var(--success)]" : "text-muted-foreground"}`}>
                  <div className={`h-7 w-7 rounded-full grid place-items-center text-xs font-semibold border-2 transition ${
                    done ? "bg-[color:var(--success)]/15 border-[color:var(--success)] text-[color:var(--success)]" :
                ...
                {i < 2 && <div className={`flex-1 h-0.5 ${done ? "bg-[color:var(--success)]/40" : "bg-border"}`} />}
              </div>
            );
          })}
        </div>
        ...
        <div className="max-w-2xl">
              ...
              <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-4 gap-2">
                    {(["Guest", "Delivery", "Service", "Cab"] as VisitorType[]).map((t) => (
                      <button
                        ...
                        style={form.purpose === t ? { background: `oklch(from ${purposeColors[t]} l c h)` } : {}}
                      >
                        {t}
                      </button>
                    ))}
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  ...
                  <div className="sm:col-span-2">
                    <label className="block">
                      <span className="text-xs font-medium text-muted-foreground">Purpose / Notes</span>
                      <div className="mt-1.5 relative">
          ...
          {step === "otp" && (
            <Card title="OTP Verification">
              ...
              <div className="mt-4">
                <div className="text-xs font-medium text-muted-foreground text-center mb-3">Enter 4-digit OTP</div>
