...
function ResidentSettings() {
  ...
  const [tab, setTab] = useState<"account" | "notifications" | "security" | "appearance">(
    "account",
  );
              ...
              <Card title="Account Information">
                <div className="space-y-3">
                  {[
                    ...
                    <div
                      key={d.label}
                      className="flex items-center justify-between text-sm p-3 rounded-xl hover:bg-foreground/5 transition"
                    >
                ...
                <div className="space-y-2">
                  {[
                    ...
                    },
                    {
                      ...
                      desc: "Status updates on your complaints",
                      defaultOn: true,
                    },
                    {
                      label: "Visitor Alerts",
                      desc: "Notifications when visitors arrive",
                      defaultOn: false,
                    },
