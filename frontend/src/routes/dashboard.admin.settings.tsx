...
import { type LucideIcon, User, Bell, Palette, Lock, Shield, Mail } from "lucide-react";
...
function SettingsPage() {
  ...
  const [tab, setTab] = useState<"profile" | "notifications" | "appearance" | "security">(
    "profile",
  );
            ...
            {tab === "profile" && (
              <Card title="Admin Profile">
                <div className="flex items-center gap-4 mb-5">
                  <div className="h-20 w-20 rounded-full bg-[image:var(--gradient-primary)] grid place-items-center text-white text-2xl font-semibold">
                    A
                  </div>
                  <div>
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  ...
                  <Field label="Email">
                    <TextInput defaultValue="admin@communa.app" />
                  </Field>
                  <Field label="Phone">
                    <TextInput defaultValue="+91 98200 00000" />
                  </Field>
                  <Field label="Role">
                    <SelectInput>
                  ...
                  <div className="sm:col-span-2">
                    <Field label="Bio">
                      <TextInput defaultValue="Operations head — Communa Heights" />
                    </Field>
                  </div>
                </div>
                  ...
                  {[
                    {
                      i: Bell,
                      l: "New complaints",
                      d: "Get notified when residents file a complaint",
                    },
                  ...
                  <Field label="Accent Color">
                    <div className="flex items-center gap-2">
                      {["265", "295", "195", "155", "25"].map((h) => (
                        <button
                          key={h}
                          className="h-9 w-9 rounded-full ring-2 ring-transparent hover:ring-primary transition"
              ...
              <Card title="Security">
                ...
                <div className="mt-5 space-y-2">
                  <Toggle
                    ...
                    desc="Add an extra security layer"
                    defaultOn
                  />
                  <Toggle
                    icon={Lock}
