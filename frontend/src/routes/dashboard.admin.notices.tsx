...
const notices = [
  {
    ...
    body: "There will be no water supply between 9 AM and 1 PM. Please store water in advance.",
    target: "All Blocks",
    date: "May 11",
    pinned: true,
    tag: "Important",
  ...
  },
  {
    ...
    body: "Mandatory fire drill at 11 AM. All residents are requested to participate.",
    target: "All Blocks",
    date: "May 09",
    pinned: false,
    tag: "Safety",
  ...
  },
  {
    ...
    body: "Treadmills and dumbbells installed in the community gym. Open from 6 AM to 10 PM.",
    target: "All Blocks",
    date: "May 05",
    pinned: false,
    tag: "Amenity",
  ...
  },
  {
    ...
    body: "Lift in Block A will be unavailable on May 18 from 10 AM to 4 PM.",
    target: "Block A",
    date: "May 03",
    pinned: false,
    tag: "Maintenance",
          ...
          <div className="lg:col-span-2">
            <Card title="Compose Notice" action={<Badge tone="primary">Draft</Badge>}>
              <div className="grid grid-cols-2 gap-3">
                <Field label="Title">
                  <TextInput placeholder="Write a clear title..." />
                </Field>
                <Field label="Tag">
                  <SelectInput>
                  ...
                  <div className="rounded-lg bg-foreground/5 border border-transparent focus-within:border-input">
                    <div className="flex items-center gap-1 px-2 py-1.5 border-b border-border/50">
                      {[Bold, Italic, List, Link2].map((Icon, i) => (
                        <button
                          key={i}
                          className="h-7 w-7 grid place-items-center rounded-md hover:bg-foreground/5 text-foreground/70"
                        >
              ...
              <div className="mt-5 flex items-center justify-end gap-2">
                <button className="h-10 px-4 rounded-lg text-sm font-medium hover:bg-foreground/5">
                  Save Draft
                </button>
                <PrimaryButton>
            ...
            <div className="space-y-3">
              {[
                ...
                >
                  <input
                    type="checkbox"
                    defaultChecked={t.b === "All Blocks"}
                    className="h-4 w-4 accent-[oklch(from_var(--primary)_l_c_h)]"
                  />
                ...
                <div key={n.id} className="rounded-xl glass p-4 hover:shadow-card transition">
                  <div className="flex items-start justify-between gap-2 mb-2">
                    <div className="flex items-center gap-2">
                      <div className="grid place-items-center h-9 w-9 rounded-lg bg-[image:var(--gradient-primary)] text-white">
